...
class Menubar:
    ...
    def __init__(self, parent):
        ...
        menubar = tk.Menu(parent.master, bg = "#191919", fg = "white")
        parent.master.config(menu=menubar,  bg = "#191919")

        file_dropdown = tk.Menu(menubar, tearoff=0, bg = "white", fg = "black")
...
class PyText:
    ...
    def __init__(self, master):
        ...
        self.textarea = tk.Text(master, bg = "white", fg = "black", insertbackground='black' ,font = ("Times", 16 ))
